...
public:
    ...
    void update_subtree_root_buffer_single (size_t subtree_index, uint32_t fif_index);
    void update_subtree_root_buffer_range (size_t start, size_t count, uint32_t fif_index);
